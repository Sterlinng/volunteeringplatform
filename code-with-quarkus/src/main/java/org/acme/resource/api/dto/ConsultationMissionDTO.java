...
public class ConsultationMissionDTO {
    ...
    public ConsultationMissionDTO(String name, String name_corporation, String address, String ZIP_code, Date date_mission, Time beginning_hour, Time end_hour, String description) {
        this.name = name;
